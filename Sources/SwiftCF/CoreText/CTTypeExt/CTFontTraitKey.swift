...
public extension CTFont.TraitKey {
    ...
    ///
    /// The value returned is a CFNumber representing a float value between -1.0 and 1.0 for normalized
    /// weight. The value of 0.0 corresponds to the regular or medium font weight.
    ...
    ///
    /// This value corresponds to the relative interglyph spacing for a given font. The value returned is a
    /// CFNumber object representing a float between -1.0 and 1.0. The value of 0.0 corresponds to regular
    ...
    ///
    /// The value returned is a CFNumber object representing a float value between -1.0 and 1.0 for
    /// normalized slant angle. The value of 0.0 corresponds to 0 degrees clockwise rotation from the
    /// vertical and 1.0 corresponds to 30 degrees clockwise rotation.
